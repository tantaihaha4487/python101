...
```mermaid
flowchart LR
  A["สัปดาห์ 1<br/>ผังงาน, รหัสเทียม, Syntax"] --> B["สัปดาห์ 2<br/>Condition, Loop, Data"]
...
- อ่านและเขียนผังงานจากโจทย์
- เขียนรหัสเทียมก่อนแปลงเป็นโค้ด
- ติดตั้ง Python และ editor
- รันไฟล์ `.py`
- เรียน variables, strings, numbers, booleans
- ใช้ตัวดำเนินการและลำดับการคำนวณ
- ฝึก `print()` และ `input()`

เป้าหมาย: ออกแบบขั้นตอนด้วยผังงานหรือรหัสเทียม แล้วเขียนโปรแกรมรับข้อมูลและแสดงผลได้
...
- อ่านและเขียนผังงานกับรหัสเทียมได้
- อธิบายตัวแปรและชนิดข้อมูลได้
- ใช้ตัวดำเนินการและลำดับการคำนวณได้ถูกต้อง
